...
\begin {itemize}[<+->]
\item 皆さんDebianって使ってますかー？\\
→\large{\textcolor{red}{使ってない人はぜひ使ってみましょう!}}
\item *-dbgパッケージって知ってますかー？\\
→\large{\textcolor{red}{使ったことない人は、家に帰ったらaptitude install XXXX-dbg！（XXXXは何か好きなパッケージで）}}
\item gdbって使ったことありますかー？/gdbのpython拡張使ったことありますかー？\\
→\large{\textcolor{red}{使ったことない人は、本資料公開してますので、ぜひ真似をしてみてー。}}
\end{itemize}
...
\begin{frame}{ところでソースのデバッグ出来ないんだけど？}
