...
\begin{frame}{Agenda}
 \begin{itemize}
  ...
  \item Debian Jessie topic update
  \item イベントのご紹介
  \item 質疑応答
 \end{itemize}
\end{frame}
...
\begin{frame}{本資料は？}
　東京エリアDebian勉強会ホームページの10月の案内\url{http://tokyodebian.alioth.debian.org/2013-10.html}にて公開してます。
...
\begin{frame}{Wheezyリリース/アップデートの状況}

\begin{itemize}
\item 2013/5/4にてWhezzyリリース(Debian 7.0)\\
\url{https://lists.debian.org/debian-announce/2013/msg00002.html}
\item 2013/6/15にてWheezyの1stアップデート(Debian 7.1)\\
\url{https://lists.debian.org/debian-announce/2013/msg00003.html}
\item 2013/10/12にてWheezyの2ndアップデート(Debian 7.2)\\
\url{https://lists.debian.org/debian-announce/2013/msg00004.html}
\end{itemize}

\end{frame}

\begin{frame}{日本国内のインストール用イメージ入手、アップグレード用ftp mirror}
...
\item インストール用イメージについては↓\\
  ...
  \end{itemize}
\item アップデート先（Lenny→Wheezyへのアップグレード用)\\
